// input_handler.h
//
// Description: Handles input for the application (mouse input)
//
//////////////////////////////////////////////////////////////////////
...
inline constexpr float CLICK_TOLERANCE { 5.0f };
...
public:
                                 ...
                                 std::vector<Constraint>& constraints)
    {
        if(event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
        {
            ...
            m_tear_cloth(mouse_x, mouse_y, constraints);
        }
    }

private:
    static float point_to_segment_distance(float px, float py, float x1, float y1,
                                           float x2, float y2)
    {
        float ABx { x2 - x1 };
        float ABy { y2 - y1 };
    ...
    static void m_tear_cloth(float mouse_x, float mouse_y, std::vector<Constraint>& constraints)
    {
